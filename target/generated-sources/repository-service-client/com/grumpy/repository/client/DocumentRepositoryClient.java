...
package com.grumpy.repository.client;

import java.net.URI;
import javax.ws.rs.client.Client;
import javax.ws.rs.client.ClientBuilder;
import com.grumpy.repository.client.builder.TenantBuilder;
import com.grumpy.repository.client.builder.TenantClientAggrBuilder;
import com.grumpy.repository.client.builder.TenantClientIndexesBuilder;
import com.grumpy.repository.client.builder.TenantClientTagsBuilder;
import com.hybris.ramler.commons.RequestParams;
import com.hybris.ramler.commons.builder.AbstractResourceBuilder;


/**
 * This the entrance point to the Document Repository client.
 * <p>
 * It is a wrapper for a JAX-RS REST client that will call the Document Repository.
 * <p>
...
public class DocumentRepositoryClient
    extends AbstractResourceBuilder<DocumentRepositoryClient>
{
     ...
     * 
     */
    public final static String DEFAULT_BASE_URI = "https://api.yaas.io/hybris/repository/b1";
    private final String baseUri;
    private final Client client;

    /**
     * Creates an instance of the {@link DocumentRepositoryClient} for the given URI.
     * 
     * @param baseUri the base URI of the service
     * 
     */
    public DocumentRepositoryClient(final String baseUri) {
     ...
     * 
     */
    public DocumentRepositoryClient(final URI baseUri) {
        this(baseUri.toString(), ClientBuilder.newClient(), new RequestParams());
    }

    /**
     * Creates an instance of the {@link DocumentRepositoryClient} for the given URI, based on the supplied JAX-RS client
     * instance.
     * <p>
     ...
     * 
     */
    public DocumentRepositoryClient(final String baseUri, final Client client) {
        this(baseUri, client, new RequestParams());
    }

    private DocumentRepositoryClient(final String baseUri, final Client client, final RequestParams params) {
    ...
    @Override
    protected DocumentRepositoryClient makeACopy(final RequestParams params) {
        return new DocumentRepositoryClient(baseUri, client, params);
    }

    /**
     * Returns a new {@link com.hybris.ramler.commons.builder.ResourceBuilder} for the sub-resource located at the relative URI: <code>/{tenant}</code>.
     * 
    ...
    /**
     * Returns a new {@link com.hybris.ramler.commons.builder.ResourceBuilder} for the sub-resource located at the relative URI: <code>/{tenant}/{client}/aggr</code>.
     * 
    ...
    /**
     * Returns a new {@link com.hybris.ramler.commons.builder.ResourceBuilder} for the sub-resource located at the relative URI: <code>/{tenant}/{client}/indexes</code>.
     * 
    ...
    /**
     * Returns a new {@link com.hybris.ramler.commons.builder.ResourceBuilder} for the sub-resource located at the relative URI: <code>/{tenant}/{client}/tags</code>.
     * 
