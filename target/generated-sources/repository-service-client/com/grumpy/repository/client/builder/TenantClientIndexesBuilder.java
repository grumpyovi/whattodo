...
/**
 * A {@link com.hybris.ramler.commons.builder.ResourceBuilder} for the <code>/{tenant}/{client}/indexes</code> resource.
 * 
    ...
    extends AbstractResourceBuilder<TenantClientIndexesBuilder>
{
    ...
    /**
     * Returns a new {@link com.hybris.ramler.commons.builder.ResourceBuilder} for the sub-resource located at the relative URI: <code>/{type}</code>.
     * 
        ...
        implements ActionWithPayloadBuilder<TenantClientIndexesBuilder.AnyActionBuilder, Object> , HttpActionSettable<TenantClientIndexesBuilder.AnyActionBuilder>
    {
        ...
        @Override
        public TenantClientIndexesBuilder.AnyActionBuilder fillMethod(com.hybris.ramler.commons.builder.ActionBuilder.HttpMethod theMethod) {
