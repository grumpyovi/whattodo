...
/**
 * A {@link com.hybris.ramler.commons.builder.ResourceBuilder} for the <code>/{id}</code> resource.
 * 
    ...
    extends AbstractResourceBuilder<TenantClientTagsTypeIdBuilder>
{
    ...
    /**
     * Returns a new {@link com.hybris.ramler.commons.builder.ResourceBuilder} for the sub-resource located at the relative URI: <code>/{tagName}</code>.
     * 
        ...
        implements ActionWithPayloadBuilder<TenantClientTagsTypeIdBuilder.AnyActionBuilder, Object> , HttpActionSettable<TenantClientTagsTypeIdBuilder.AnyActionBuilder>
    {
        ...
        @Override
        public TenantClientTagsTypeIdBuilder.AnyActionBuilder fillMethod(com.hybris.ramler.commons.builder.ActionBuilder.HttpMethod theMethod) {
