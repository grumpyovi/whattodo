...
/**
 * A {@link com.hybris.ramler.commons.builder.ResourceBuilder} for the <code>/{tenant}/{client}/aggr</code> resource.
 * 
    ...
    extends AbstractResourceBuilder<TenantClientAggrBuilder>
{
        ...
        implements ActionWithPayloadBuilder<TenantClientAggrBuilder.AnyActionBuilder, Object> , HttpActionSettable<TenantClientAggrBuilder.AnyActionBuilder>
    {
        ...
        @Override
        public TenantClientAggrBuilder.AnyActionBuilder fillMethod(com.hybris.ramler.commons.builder.ActionBuilder.HttpMethod theMethod) {
