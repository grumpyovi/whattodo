    ...
    extends AbstractResourceBuilder<TenantClientIndexesTypeBuilder>
{
    ...
    /**
     * Returns a new {@link com.hybris.ramler.commons.builder.ResourceBuilder} for the sub-resource located at the relative URI: <code>/{name}</code>.
     * 
        ...
        implements ActionWithPayloadBuilder<TenantClientIndexesTypeBuilder.AnyActionBuilder, Object> , HttpActionSettable<TenantClientIndexesTypeBuilder.AnyActionBuilder>
    {
        ...
        @Override
        public TenantClientIndexesTypeBuilder.AnyActionBuilder fillMethod(com.hybris.ramler.commons.builder.ActionBuilder.HttpMethod theMethod) {
