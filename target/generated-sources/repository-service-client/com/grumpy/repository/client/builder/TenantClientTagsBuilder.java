...
/**
 * A {@link com.hybris.ramler.commons.builder.ResourceBuilder} for the <code>/{tenant}/{client}/tags</code> resource.
 * 
    ...
    extends AbstractResourceBuilder<TenantClientTagsBuilder>
{
        ...
        implements ActionWithPayloadBuilder<TenantClientTagsBuilder.AnyActionBuilder, Object> , HttpActionSettable<TenantClientTagsBuilder.AnyActionBuilder>
    {
        ...
        @Override
        public TenantClientTagsBuilder.AnyActionBuilder fillMethod(com.hybris.ramler.commons.builder.ActionBuilder.HttpMethod theMethod) {
