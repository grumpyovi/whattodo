    ...
    extends AbstractResourceBuilder<TenantClientTagsTypeBuilder>
{
    ...
    /**
     * Returns a new {@link com.hybris.ramler.commons.builder.ResourceBuilder} for the sub-resource located at the relative URI: <code>/{id}</code>.
     * 
        ...
        implements ActionWithPayloadBuilder<TenantClientTagsTypeBuilder.AnyActionBuilder, Object> , HttpActionSettable<TenantClientTagsTypeBuilder.AnyActionBuilder>
    {
        ...
        @Override
        public TenantClientTagsTypeBuilder.AnyActionBuilder fillMethod(com.hybris.ramler.commons.builder.ActionBuilder.HttpMethod theMethod) {
